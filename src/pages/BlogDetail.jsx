            ...
            <section style={{
                ...
                <div style={{ position: 'relative', zIndex: 1, maxWidth: '600px', margin: '0 auto' }}>
                    ...
                    <p style={{
                        ...
                        Abonnieren Sie unseren Newsletter und erhalten Sie regelmäßig:
                    </p>
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <p style={{
                                ...
                                margin: 0
                            }}>Praktische Ratschläge für sicheren Transport</p>
                        </div>
                        ...
                        <div style={{
                            ...
                            <p style={{
                                ...
                                color: 'var(--text-muted)',
                                margin: 0
                            }}>Exklusive Rabatte und Aktionen</p>
                        </div>
                        ...
                        <div style={{
                            ...
                            <h4 style={{
                                ...
                                color: 'var(--primary)',
                                fontSize: '1.1rem'
                            }}>Montage-Anleitungen</h4>
                            <p style={{
                                fontSize: '0.9rem',
                                color: 'var(--text-muted)',
                                margin: 0
                            }}>Schritt-für-Schritt Guides</p>
                        </div>
                    </div>
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            💡 <em>Im Schnitt 1-2 Newsletter pro Monat – keine Spam-Mails!</em>
                        </div>
                    </div>
                </div>
            </section>
